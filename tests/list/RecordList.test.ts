...
import {RecordList} from "../../src/list/RecordList";
...
describe("RecordList", () => {
    ...
    describe("#addAll()", () => {
        it("should add all elements from the second list to this list", () => {
            const list1 = new RecordList([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla]);
            const list2 = new RecordList([Person.Vanessa, Person.Viola]);
        ...
        it("should return true if list is changed as a result (and false if not)", () => {
            const list1 = new RecordList([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla]);
            const list2 = new RecordList([Person.Vanessa, Person.Viola]);
            const list3 = new RecordList<Person>();
    ...
    describe("#addAt()", () => {
        it("should throw error if index is out of bounds", () => {
            const list = new RecordList([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla]);
    ...
    describe("#aggregate()", () => {
        ...
        it("should throw error if list is empty and no seed is provided", () => {
            const list = new RecordList<number>([]);
    ...
    describe("#all()", () => {
        const list = new RecordList([Person.Alice, Person.Mel, Person.Senna, null, Person.Jane]);
    ...
    describe("#append()", () => {
        it("should append the given element at the end of enumerable", () => {
            const list = new RecordList([1, 2, 3, 4, 5]);
    ...
    describe("#average()", () => {
        it("should return 99948748093", () => {
            const list = new RecordList(["10007", "37", "299846234235"]);
        ...
        it("should throw error if list is empty", () => {
            const list = new RecordList<string>([]);
            expect(() => list.average(s => parseInt(s, 10))).to.throw(ErrorMessages.NoElements);
        });
    });

    describe("#clear()", () => {
        const list1 = new RecordList([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla, Person.Vanessa, Person.Viola]);
    ...
    describe("#concat()", () => {
        it("should return a list with [1,2,3,4,5,5,6,7,8,9]", () => {
            const list1 = new RecordList([1, 2, 3, 4, 5]);
            const list2 = new RecordList([5, 6, 7, 8, 9]);
    ...
    describe("#contains()", () => {
        const list = new RecordList([1, 3, 5, 6, 7, 8, 9, 2, 0, -1, 99, -99]);
        const personList = new RecordList([Person.Alice, Person.Mel, Person.Senna]);
        ...
        it("should run fast with big collections", () => {
            ...
            const list = new RecordList(bigPeopleArray);
    ...
    describe("#count()", () => {
        it("should return 2", () => {
            const list = new RecordList<Person>();
        ...
        it("should return 5", () => {
            const list = new RecordList([1, 9, 2, 8, 3, 7, 4, 6, 5, 0]);
    ...
    describe("#distinct()", () => {
        it("should remove duplicate elements", () => {
            const list = new RecordList([Person.Alice, Person.Mel, Person.Senna, Person.Mel, Person.Alice]);
        ...
        it("should use default comparator if no comparator is provided", () => {
            const list1 = new RecordList([1, 2, 3, 1, 1, 1, 4, 5, 4, 3]);
            const list2 = new RecordList(["Alice", "Vanessa", "Misaki", "Alice", "Misaki", "Megumi", "Megumi"]);
        ...
        it("should use provided comparator for key comparison", () => {
            const list2 = new RecordList([Person.Alice, Person.Hanna, Person.Hanna2, Person.Noemi, Person.Noemi2]);
    ...
    describe("#elementAt()", () => {
        const list = new RecordList([1, 48, 6, 195, 47]);
        it("should return 48", () => {
    ...
    describe("#entries()", () => {
        it("should return an indexed IterableIterator", () => {
            const list = new RecordList(Enumerable.range(1, 100));
    ...
    describe("#except()", () => {
        it("should return an array of [1,2,3]", () => {
            const list1 = new RecordList([1, 2, 3, 3, 4, 5]);
            const list2 = new RecordList([4, 5, 6, 7, 8]);
            const elist = new RecordList(list1.except(list2));
            expect(elist.toArray()).to.deep.equal([1, 2, 3]);
            expect(elist.Count).to.eq(3);
        });
        it("should return an array of [1,2]", () => {
            const list1 = new RecordList([1, 2, 3, 3, 4, 5]);
            const list2 = new RecordList([3, 4, 5, 6, 7, 8]);
            const elist = new RecordList(list1.except(list2));
            expect(elist.toArray()).to.deep.equal([1, 2]);
        });
        it("should only have 'Alice', 'Noemi' and 'Senna'", () => {
            const list1 = new RecordList([Person.Alice, Person.Noemi, Person.Mel, Person.Senna, Person.Lenka, Person.Jane]);
            const list2 = new RecordList([Person.Mel, Person.Lenka, Person.Jane, Person.Noemi2]);
    ...
    describe("#first()", () => {
        ...
        it("should return the first element if no predicate is provided.", () => {
            const list = new RecordList([99, 2, 3, 4, 5]);
        ...
        it("should return a person with name 'Alice'", () => {
            const list = new RecordList([Person.Mel, Person.Alice, Person.Jane]);
    ...
    describe("#groupBy()", () => {
        const list = new RecordList([Person.Alice, Person.Mel, Person.Senna, Person.Lenka, Person.Jane, Person.Karen, Person.Reina]);
    ...
    describe("#groupJoin()", () => {
        ...
        const schools = new RecordList([school1, school2, school3, school4]);
        const students = new RecordList([desiree, apolline, giselle, priscilla, lucrezia]);
    ...
    describe("#indexOf", () => {
        const list1 = new RecordList([Person.Alice, Person.Noemi, null, Person.Noemi2, null]);
        it("should return 2", () => {
    ...
    describe("#intersect()", () => {
        ...
        it("should return an array of [3, 4, 5]", () => {
            const list1 = new RecordList([1, 2, 3, 3, 4, 5, 5, 5, 11]);
            const list2 = new RecordList([3, 3, 3, 4, 4, 5, 5, 6, 7, 8]);
            const elist = list1.intersect(list2).toList();
    ...
    describe("#join()", () => {
        ...
        const priscilla = new Student(400, "Priscilla", "Necci", 1);
        const lucrezia = new Student(500, "Lucrezia", "Volpe", 4);
        const schools = new RecordList([school1, school2, school3]);
        const students = new RecordList([desiree, apolline, giselle, priscilla, lucrezia]);
        ...
        it("should join key-value pairs", () => {
            const pairList1 = new RecordList([new Pair(1, "A"), new Pair(2, "B"), new Pair(3, "C")]);
            const pairList2 = new RecordList([new Pair(1, "a1"), new Pair(1, "a2"), new Pair(1, "a3"), new Pair(2, "b1"), new Pair(2, "b2")]);
    ...
    describe("#last()", () => {
        ...
        it("should return 87", () => {
            const list = new RecordList([9, 34, 65, 92, 87, 435, 3, 54, 83, 23, 87, 67, 12, 19]);
    ...
    describe("#max()", () => {
        const list = new RecordList([43, 56, 123, 65, 1, 6, 900, 2312, 555, 1011]);
        ...
        it("should return 23", () => {
            const personList = new RecordList([Person.Alice, Person.Mel, Person.Senna, Person.Lenka, Person.Jane]);
    ...
    describe("#orderBy()", () => {
        it("should order people by age [asc]", () => {
            const people = new RecordList([Person.Alice, Person.Lenka, Person.Jane, Person.Jisu, Person.Karen, Person.Mel, Person.Rebecca, Person.Reina, Person.Senna, Person.Vanessa, Person.Viola]);
    ...
    describe("#prepend()", () => {
        ...
        it("should return a new list", () => {
            const newList = new RecordList(list.prepend(Person.Lenka));
            expect(list.size()).to.eq(2);
    ...
    describe("#removeAll()", () => {
        it("should remove the elements of second list from first list", () => {
            const list1 = new RecordList([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla, Person.Vanessa, Person.Viola]);
            const list2 = new RecordList([Person.Vanessa, Person.Viola, Person.Noemi2]);
        ...
        it("should use the provided comparator for comparison", () => {
            const list1 = new RecordList([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla, Person.Vanessa, Person.Viola], personNameComparator);
            const list2 = new RecordList([Person.Vanessa, Person.Viola, Person.Noemi2]);
            list1.removeAll(list2);
    ...
    describe("#retainAll()", () => {
        it("should remove elements that are not in the specified list", () => {
            const list1 = new RecordList([3, 4, 1, 2, 5]);
            const list2 = new RecordList([5, 4]);
    ...
    describe("#reverse()", () => {
        const list: RecordList<Person> = new RecordList<Person>();
        list.add(Person.Alice);
    ...
    describe("#select()", () => {
        ...
        it("should return an IEnumerable with elements [4, 25, 36, 81]", () => {
            const list = new RecordList([2, 5, 6, 9]);
    ...
    describe("#selectMany()", () => {
        ...
        it("should return a flattened array of ages #1", () => {
            ...
            const peopleList = new RecordList(people);
        ...
        it("should return a flattened array of ages #2", () => {
            const people: Person[] = [];
            Person.Viola.friendsList = new RecordList([Person.Rebecca]);
            Person.Jisu.friendsList = new RecordList([Person.Alice, Person.Mel]);
            Person.Vanessa.friendsList = new RecordList([Person.Viola, Person.Rebecca, Person.Jisu, Person.Alice]);
            Person.Rebecca.friendsList = new RecordList([Person.Viola]);
            people.push(Person.Viola);
            people.push(Person.Rebecca);
            people.push(Person.Jisu);
            people.push(Person.Vanessa);
    ...
    describe("#sequenceEqual()", () => {
        it("should return false for lists with different sizes", () => {
            const list1 = new RecordList([1, 2]);
            const list2 = new RecordList([1, 2, 3]);
            expect(list1.sequenceEqual(list2)).to.eq(false);
        });
        it("should return false if lists don't have members in the same order", () => {
            const list1 = new RecordList([1, 2]);
            const list2 = new RecordList([2, 1]);
            expect(list1.sequenceEqual(list2)).to.eq(false);
        });
        it("should return true if lists have members in the same order", () => {
            const list1 = new RecordList([1, 2]);
            const list2 = new RecordList([1, 2]);
            expect(list1.sequenceEqual(list2)).to.eq(true);
        });
        it("should return true if lists have members in the same order", () => {
            const list1 = new RecordList([Person.Alice, Person.Mel, Person.Lenka, Person.Noemi]);
            const list2 = new RecordList([Person.Alice, Person.Mel, Person.Lenka, Person.Noemi2]);
    ...
    describe("#singleOrDefault()", () => {
        ...
        it("should return the only element in the list", () => {
            const list2 = new RecordList<string>();
            list2.add("Suzuha");
    ...
    describe("#skip()", () => {
        const list = new RecordList([1, 2, 3, 4, 5, 6, 7]);
        it("should return a list with elements [5,6,7]", () => {
            const list2 = new RecordList(list.skip(4));
    ...
    describe("#skipLast()", () => {
        ...
        it("should return a list with elements [1,2,3]", () => {
            const list2 = new RecordList(list.skipLast(4));
    ...
    describe("#skipWhile()", () => {
        const list = new RecordList([5000, 2500, 9000, 8000, 6500, 4000, 1500, 5500]);
        ...
        it("should return an IEnumerable with elements [4000, 1500, 5500]", () => {
            const list2 = new RecordList(list.skipWhile((n, nx) => n > nx * 1000));
    ...
    describe("#sort", () => {
        it("should sort list with the specified constructor", () => {
            const list = new RecordList([Person.Noemi, Person.Alice, Person.Lucrezia, Person.Priscilla, Person.Eliza, Person.Bella]);
        ...
        it("should sort list with the default comparator if no comparator is specified", () => {
            const list = new RecordList([3, 1, -1, 8, 10, -9]);
            list.sort();
    ...
    describe("#sum()", () => {
        it("should return 21", () => {
            const list = new RecordList([1, 2, 3, 4, 5, 6]);
    ...
    describe("#takeWhile()", () => {
        const list = new RecordList(["apple", "banana", "mango", "orange", "plum", "grape"]);
    ...
    describe("#thenBy()", () => {
        ...
        it("should order people by age [asc] then by name[asc] then by surname[asc]", () => {
            const people = new RecordList([Person.Bella, Person.Amy, Person.Emily, Person.Eliza, Person.Hanna, Person.Hanna2,
    ...
    describe("#toLookup()", () => {
        const list = new RecordList([Person.Suzuha, Person.Suzuha2, Person.Suzuha3, Person.Noemi, Person.Noemi2, Person.Hanna, Person.Hanna2]);
    ...
    describe("#union()", () => {
        it("should return a set of items from two lists", () => {
            const list1 = new RecordList([1, 2, 3, 4, 5, 5, 5]);
            const list2 = new RecordList([4, 5, 6, 7, 8, 9, 7]);
            const union = list1.union(list2, (n1, n2) => n1 === n2);
            expect(union.toArray()).to.deep.equal([1, 2, 3, 4, 5, 6, 7, 8, 9]);
        });
        it("should use default comparator if no comparator is provided", () => {
            const list1 = new RecordList(["Alice", "Misaki", "Megumi", "Misaki"]);
            const list2 = new RecordList(["Alice", "Rei", "Vanessa", "Vanessa", "Yuzuha"]);
    ...
    describe("#zip()", () => {
        const numberList = new RecordList([1, 2, 3, 4]);
        const stringList = new RecordList(["one", "two", "three"]);
        ...
        it("should return array of tuple if predicate is null", () => {
            const list = new RecordList([2, 5, 6, 99]);
            const list2 = new RecordList([true, true, false, true]);
