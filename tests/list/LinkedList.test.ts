...
describe("LinkedList", () => {
    ...
    describe("#addAll()", () => {
        it("should add all elements from the second list to this list", () => {
            const list1 = LinkedList.from([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla]);
            const list2 = LinkedList.from([Person.Vanessa, Person.Viola]);
    ...
    describe("#addAt()", () => {
        it("should throw error if index is out of bounds", () => {
            const list = LinkedList.from([Person.Alice, Person.Lucrezia, Person.Noemi, Person.Priscilla]);
    ...
    describe("#aggregate()", () => {
        it("should return 6", () => {
            const list = LinkedList.from([4, 8, 8, 3, 9, 0, 7, 8, 2]);
            const result = list.aggregate((total, next) => next % 2 === 0 ? total + 1 : total, 0);
            expect(result).to.eq(6);
        });
        it("should return pomegranate", () => {
            const list = LinkedList.from(["apple", "mango", "orange", "pomegranate", "grape"]);
        ...
        it(`should throw if aggregator is null`, () => {
            const list = LinkedList.from([2, 5, 6, 99]);
    ...
    describe("#all()", () => {
        const list = LinkedList.from([Person.Alice, Person.Mel, Person.Senna, null, Person.Jane]);
    ...
    describe("#average()", () => {
        it("should return 99948748093", () => {
            const list = LinkedList.from(["10007", "37", "299846234235"]);
    ...
    describe("#concat()", () => {
        it("should return a list with [1,2,3,4,5,5,6,7,8,9]", () => {
            const list1 = LinkedList.from([1, 2, 3, 4, 5]);
            const list2 = LinkedList.from([5, 6, 7, 8, 9]);
    ...
    describe("#contains()", () => {
        const list = LinkedList.from([1, 3, 5, 6, 7, 8, 9, 2, 0, -1, 99, -99]);
        const personList = LinkedList.from([Person.Alice, Person.Mel, Person.Senna]);
    ...
    describe("#count()", () => {
        ...
        it("should return 5", () => {
            const list = LinkedList.from([1, 9, 2, 8, 3, 7, 4, 6, 5, 0]);
    ...
    describe("#distinct()", () => {
        it("should remove duplicate elements", () => {
            const list = LinkedList.from([Person.Alice, Person.Mel, Person.Senna, Person.Mel, Person.Alice]);
        ...
        it("should use default comparator if no comparator is provided", () => {
            const list1 = LinkedList.from([1, 2, 3, 1, 1, 1, 4, 5, 4, 3]);
            const list2 = LinkedList.from(["Alice", "Vanessa", "Misaki", "Alice", "Misaki", "Megumi", "Megumi"]);
    ...
    describe("#elementAt()", () => {
        const list = LinkedList.from([1, 48, 6, 195, 47]);
        it("should return 48", () => {
    ...
    describe("#except()", () => {
        it("should return an array of [1,2,3]", () => {
            const list1 = LinkedList.from([1, 2, 3, 4, 5]);
            const list2 = LinkedList.from([4, 5, 6, 7, 8]);
            const elist = list1.except(list2).toList();
            expect(elist.toArray()).to.deep.equal([1, 2, 3]);
        });
        it("should only have 'Alice' and 'Senna'", () => {
            const list1 = LinkedList.from([Person.Alice, Person.Mel, Person.Senna, Person.Lenka, Person.Jane]);
            const list2 = LinkedList.from([Person.Mel, Person.Lenka, Person.Jane]);
    ...
    describe("#first()", () => {
        ...
        it("should return the first element if no predicate is provided.", () => {
            const list = LinkedList.from([99, 2, 3, 4, 5]);
        ...
        it("should return a person with name 'Alice'", () => {
            const list = LinkedList.from([Person.Mel, Person.Alice, Person.Jane]);
    ...
    describe("#groupBy()", () => {
        const list = LinkedList.from([Person.Alice, Person.Mel, Person.Senna, Person.Lenka, Person.Jane, Person.Karen, Person.Reina]);
    ...
    describe("#groupJoin()", () => {
        ...
        const schools = LinkedList.from([school1, school2, school3, school4]);
        const students = LinkedList.from([desiree, apolline, giselle, priscilla, lucrezia]);
    ...
    describe("#indexOf", () => {
        const list1 = LinkedList.from([Person.Alice, Person.Noemi, null, Person.Noemi2, null]);
        it("should return 2", () => {
    ...
    describe("#join()", () => {
        ...
        const priscilla = new Student(400, "Priscilla", "Necci", 1);
        const lucrezia = new Student(500, "Lucrezia", "Volpe", 4);
        const schools = LinkedList.from([school1, school2, school3]);
        const students = LinkedList.from([desiree, apolline, giselle, priscilla, lucrezia]);
        ...
        it("should join key-value pairs", () => {
            const pairList1 = LinkedList.from([new Pair(1, "A"), new Pair(2, "B"), new Pair(3, "C")]);
            const pairList2 = LinkedList.from([new Pair(1, "a1"), new Pair(1, "a2"), new Pair(1, "a3"), new Pair(2, "b1"), new Pair(2, "b2")]);
    ...
    describe("#last()", () => {
        ...
        it("should return 87", () => {
            const list = LinkedList.from([9, 34, 65, 92, 87, 435, 3, 54, 83, 23, 87, 67, 12, 19]);
    ...
    describe("#max()", () => {
        ...
        it("should return 23", () => {
            const personList = LinkedList.from([Person.Alice, Person.Mel, Person.Senna, Person.Lenka, Person.Jane]);
    ...
    describe("#orderBy()", () => {
        it("should order people by age [asc]", () => {
            const people = LinkedList.from([Person.Alice, Person.Lenka, Person.Jane, Person.Jisu, Person.Karen, Person.Mel, Person.Rebecca, Person.Reina, Person.Senna, Person.Vanessa, Person.Viola]);
    ...
    describe("#retainAll()", () => {
        it("should remove elements that are not in the specified list", () => {
            const list1 = LinkedList.from([3, 4, 1, 2, 5]);
            const list2 = LinkedList.from([5, 4]);
    ...
    describe("#select()", () => {
        ...
        it("should return an IEnumerable with elements [4, 25, 36, 81]", () => {
            const list = LinkedList.from([2, 5, 6, 9]);
    ...
    describe("#selectMany()", () => {
        ...
        it("should return a flattened array of ages #1", () => {
            ...
            const peopleList = LinkedList.from(people);
        ...
        it("should return a flattened array of ages #2", () => {
            const people: Person[] = [];
            Person.Viola.friendsList = LinkedList.from([Person.Rebecca]);
            Person.Jisu.friendsList = LinkedList.from([Person.Alice, Person.Mel]);
            Person.Vanessa.friendsList = LinkedList.from([Person.Viola, Person.Rebecca, Person.Jisu, Person.Alice]);
            Person.Rebecca.friendsList = LinkedList.from([Person.Viola]);
            people.push(Person.Viola);
            people.push(Person.Rebecca);
            people.push(Person.Jisu);
            people.push(Person.Vanessa);
    ...
    describe("#sequenceEqual()", () => {
        it("should return false for lists with different sizes", () => {
            const list1 = LinkedList.from([1, 2]);
            const list2 = LinkedList.from([1, 2, 3]);
            expect(list1.sequenceEqual(list2)).to.eq(false);
        });
        it("should return false if lists don't have members in the same order", () => {
            const list1 = LinkedList.from([1, 2]);
            const list2 = LinkedList.from([2, 1]);
            expect(list1.sequenceEqual(list2)).to.eq(false);
        });
        it("should return true if lists have members in the same order", () => {
            const list1 = LinkedList.from([1, 2]);
            const list2 = LinkedList.from([1, 2]);
            expect(list1.sequenceEqual(list2)).to.eq(true);
        });
        it("should return true if lists have members in the same order", () => {
            const list1 = LinkedList.from([Person.Alice, Person.Mel, Person.Lenka, Person.Noemi]);
            const list2 = LinkedList.from([Person.Alice, Person.Mel, Person.Lenka, Person.Noemi2]);
    ...
    describe("#skip()", () => {
        const list = LinkedList.from([1, 2, 3, 4, 5, 6, 7]);
    ...
    describe("#skipWhile()", () => {
        const list = LinkedList.from([5000, 2500, 9000, 8000, 6500, 4000, 1500, 5500]);
    ...
    describe("#takeWhile()", () => {
        const list = LinkedList.from(["apple", "banana", "mango", "orange", "plum", "grape"]);
    ...
    describe("#thenBy()", () => {
        ...
        it("should order people by age [asc] then by name[asc] then by surname[asc]", () => {
            const people = LinkedList.from([Person.Bella, Person.Amy, Person.Emily, Person.Eliza, Person.Hanna, Person.Hanna2,
    ...
    describe("#union()", () => {
        it("should return a set of items from two lists", () => {
            const list1 = LinkedList.from([1, 2, 3, 4, 5, 5, 5]);
            const list2 = LinkedList.from([4, 5, 6, 7, 8, 9, 7]);
            const union = list1.union(list2, (n1, n2) => n1 === n2);
            expect(union.toArray()).to.deep.equal([1, 2, 3, 4, 5, 6, 7, 8, 9]);
        });
        it("should use default comparator if no comparator is provided", () => {
            const list1 = LinkedList.from(["Alice", "Misaki", "Megumi", "Misaki"]);
            const list2 = LinkedList.from(["Alice", "Rei", "Vanessa", "Vanessa", "Yuzuha"]);
    ...
    describe("#zip()", () => {
        const numberList = LinkedList.from([1, 2, 3, 4]);
        const stringList = LinkedList.from(["one", "two", "three"]);
        ...
        it("should return array of tuple if predicate is null", () => {
            const list = LinkedList.from([2, 5, 6, 99]);
            const list2 = LinkedList.from([true, true, false, true]);
