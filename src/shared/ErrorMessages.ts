export abstract class ErrorMessages {
    ...
    public static readonly NoPredicateProvided: string = "predicate is null.";
    public static readonly NoSelectorProvided: string = "selector is null.";
    public static readonly NoElements: string = "Sequence contains no elements.";
    public static readonly NoMatchingElement: string = "Sequence contains no matching element.";
}
